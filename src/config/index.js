...
const config = {
  ...
  APP_URL: process.env.APP_URL || (process.env.RAILWAY_STATIC_URL ? `https://${process.env.RAILWAY_STATIC_URL}` : ''),
  ...
  validateConfig: function() {
    ...
    if (this.IS_PRODUCTION && !this.APP_URL) {
      throw new Error('No se pudo determinar una URL pública para el webhook. Asegúrate de que Railway esté configurado correctamente o define APP_URL manualmente.');
    }
